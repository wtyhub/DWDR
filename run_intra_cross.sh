...
# baseline
python train_intra_cross.py \
--name='two_view_long_share_d0.75_256_s1_lr0.01_balance_intra-cross_decouple_lambd768_g0.9_e22_v9' \
--data_dir='/home/wangtingyu/datasets/University-Release/train' \
--views=3 \
--droprate=0.75 \
--share \
...
--fp16 \
--lambd=0.0013 \
--experiment_name='two_view_long_share_d0.75_256_s1_lr0.01_balance_intra-cross_decouple_lambd768_g0.9_e22_v9' \
--gpu_ids='5' \
--seed=3
